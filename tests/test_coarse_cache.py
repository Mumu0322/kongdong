...
class CoarseCacheTests(unittest.TestCase):
    ...
    @staticmethod
    def _panel_for_command(strategy: str = "per_hole") -> HoleLocalizationPanel:
    ...
    def test_gui_cache_flags_are_derived_from_detection_strategy(self) -> None:
    ...
    def test_gui_per_hole_strategy_disables_shared_fine_path(self) -> None:
        ...
        self.assertNotIn("--batch-fine-localization", command)
        self.assertNotIn("--batch-fine-joint-localization", command)

    def test_gui_shared_strategy_restores_shared_fine_path(self) -> None:
        panel = self._panel_for_command("per_hole")
    ...
    def test_gui_per_hole_strategy_ignores_shared_fine_parameter_values(self) -> None:
        panel = self._panel_for_command("per_hole")
        panel.batch_fine_localization_var = _Value(True)
        panel.batch_fine_joint_localization_var = _Value(True)
        panel.shared_cache_validation_var = _Value(False)
        panel.batch_fine_view_margin_var = _Value("invalid")
        panel.batch_fine_frames_var = _Value("invalid")
        panel.batch_fine_min_valid_var = _Value("invalid")
        panel.batch_fine_stable_min_frames_var = _Value("invalid")
        panel.batch_fine_settle_discard_frames_var = _Value("invalid")
        panel.batch_fine_inplace_recovery_frames_var = _Value("invalid")
        panel.batch_fine_supplement_rounds_var = _Value("invalid")
        panel._update_strategy_controls = lambda: None
