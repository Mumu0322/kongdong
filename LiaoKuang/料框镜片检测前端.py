...
try:
    from aubo_workbench.orbbec_paths import add_orbbec_runtime_path

    add_orbbec_runtime_path()
except Exception:
    # The standalone front end keeps its existing error panel when the local
    # runtime is not installed; the main workbench reports the same condition.
    pass
