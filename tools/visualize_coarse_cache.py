...
示例：
    ...
    python tools/visualize_coarse_cache.py ^
        --cache-dir C:\MM_two\aubo_tools\data\hole_localization_coarse_cache ^
        --hole-id 3 --show

    python tools/visualize_coarse_cache.py ^
        --cache-dir C:\MM_two\aubo_tools\data\hole_localization_coarse_cache ^
        --hole-id 3 ^
        --rgb C:\MM_two\aubo_tools\data\hole_localization_runs\...\01_home_selected.png ^
        --output C:\MM_two\tmp\cache_hole_03.png
"""
